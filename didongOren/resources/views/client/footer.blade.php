<div id="box-footer">   
    ...
    <div class="box-footer-bottom">
        ...
        <div class="row">
            ...
            <div class="box-right">
                <ul>
                <li><img src="{{URL::asset('images/p1.png')}}" alt="" /></li>
                <li><img src="{{URL::asset('images/p2.png')}}" alt="" /></li>
                <li><img src="{{URL::asset('images/p3.png')}}" alt="" /></li>
                <li><img src="{{URL::asset('images/p4.png')}}" alt="" /></li>
                </ul>
            </div>
            </div>
        </div>
...
$('.btn-delete-cart, .btn-remove').click(function(){
    var product_id = $(this).attr('data-id');
    var product_name = $(this).attr('data-name');
