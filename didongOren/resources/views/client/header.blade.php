                                                ...
                                                @foreach(Session::get('cart') as $id => $info)
                                                    <li class="item" id="product-{{$id}}">
                                                        ...
                                                        <div class="product-details">
                                                            ...
                                                            <div class="qty-abc">
                                                                <a title="Decrement" class="qty-change-left" href="#" data-id="{{$id}}" data-name="{{$info['product']->name}}">down</a>
                                                                <input class="input-text qty-header" type="text" value="{{$info['quantity']}}" data-id="{{$id}}"/>
                                                                <a title="Increment" class="qty-change-right" href="#" data-id="{{$id}}" data-name="{{$info['product']->name}}" >up</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endforeach
